...
namespace TNet.Contract.Action
{
    ...
    public class PayNormalAction : BaseStruct
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TNet.Contract.Action.PayNormalAction"/> class.
        /// </summary>
        ...
        private void Check10086Payment(OrderInfo orderInfo)
        {
            try
            {
                ...
                int orderType = 1;
                GameChannel gameChannel = TNGameBaseConfigManager.GameSetting.GetChannelSetting(ChannelType.channel10086);
                if (gameChannel != null)
                {
                    url = gameChannel.Url;
