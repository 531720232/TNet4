...
namespace TNet.Contract
{
    ...
    public static class ActionFactory
    {
        ...
        {
            Request(Runtime.GameZone.Setting.ActionTypeName);
        }
        ...
        {
          Request(Runtime.GameZone.Setting.ActionTypeName, actionGetter, response);
        }
        ...
        {
            string scriptTypeName = string.Format(TNet.Runtime.GameZone.Setting.ScriptTypeName, actionId);
            string scriptCode = "";
