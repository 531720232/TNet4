  ...
  public  class TNSocket
    {
        ...
        private System.Collections.Concurrent.ConcurrentQueue<SocketAsyncResult> sendQueue;
        ...
        public TNSocket(System.Net.Sockets.Socket socket)
        {
            ...
            sendQueue = new System.Collections.Concurrent.ConcurrentQueue<SocketAsyncResult>();
            this.socket = socket;
            InitData();
        }
