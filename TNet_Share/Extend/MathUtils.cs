...
namespace TNet.Extend
{
    public static class MathUtils 
    {
        ...
        {
            get { return _runtimeBinPath ?? (_runtimeBinPath = AppDomain.CurrentDomain.BaseDirectory+"/lib" ?? RuntimePath); }
        ...
        public static string RuntimePath
        {
            get
            {
                ...
                return _runtimePath ?? (_runtimePath = AppDomain.CurrentDomain.BaseDirectory);
            }
        }
