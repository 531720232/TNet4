    ...
    public abstract   class TypeAccessor
    {
        ...
        static TypeAccessor CreateNew(Type type, bool allowNonPublicAccessors)
        {
            ...
            if (assembly == null)
            {
                ...
                assembly = AssemblyBuilder.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run);//.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run);
