...
namespace EcsRx.Entities
{
    public class Entity : IEntity
    {
        ...
        public IEntity Parent { get=>m_Parent ; set { m_Parent = value; } }
        public IEnumerable<IEntity> Children { get => entities; set { entities = new LinkedList<IEntity>(value); } } 
        ...
        public void AddChildren(params IEntity[] parent)
        {
        ...
        public void RemoveChildren(params IEntity[] parent)
        {
            foreach (var p in parent)
            {
